...
* estimation accuracy of vicariance under idealised simulations varying model settings 
...
* ...
* `sbatch bash/run_analysis.sh 22`
* `sbatch bash/run_analysis.sh 23`
* `sbatch bash/run_analysis.sh 24`
